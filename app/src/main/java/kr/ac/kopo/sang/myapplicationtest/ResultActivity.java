...
public class ResultActivity extends AppCompatActivity {
            ...
            registerForActivityResult(
                    ...
                    result -> {
                        ...
                        if (result.getResultCode() == RESULT_OK
                            ...
                            String selectedTime =
                                    result.getData()
                                            .getStringExtra("selectedTime");

                            if (selectedTime != null
                                    && targetPosition != -1) {

                                resultList.get(targetPosition)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultList =
                (ArrayList<TodoItem>)
                        getIntent().getSerializableExtra("todoData");
        ...
        ListView lvResult =
                findViewById(R.id.lv_result);

        btnDeleteMode =
                findViewById(R.id.btn_delete_mode);
    ...
    private void saveData() {
        ...
        SharedPreferences sp =
                getSharedPreferences("todo_prefs",
                        MODE_PRIVATE);
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int p,
            ...
            if (v == null) {
                ...
                v = getLayoutInflater()
                        .inflate(R.layout.activity_todo,
                                parent,
                                false);
            }
            ...
            CheckBox cb =
                    v.findViewById(R.id.cb_delete);

            TextView title =
                    v.findViewById(R.id.tv_todo_text);

            TextView time =
                    v.findViewById(R.id.tv_todo_time);

            Button btnTimer =
                    v.findViewById(R.id.btn_set_timer);
            ...
            btnEdit.setOnClickListener(view -> {
                ...
                EditText editText =
                        new EditText(ResultActivity.this);
